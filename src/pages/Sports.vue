  ...
  <div class="q-pa-md q-gutter-sm">
    <q-parallax :height="150">
      <template v-slot:media>
        <video poster="https://player.vimeo.com/external/449244484.hd.mp4?s=b238bfaef57eddd2e16e088b9597253354f69be7&profile_id=174" autoplay loop muted>
          <source type="video/webm" src="https://player.vimeo.com/external/449244484.hd.mp4?s=b238bfaef57eddd2e16e088b9597253354f69be7&profile_id=174">
          <source type="video/mp4" src="https://player.vimeo.com/external/449244484.hd.mp4?s=b238bfaef57eddd2e16e088b9597253354f69be7&profile_id=174">
        </video>
      </template>
...
<script>
  export default {
    ...
    methods: {
      ...
      fetchTopNews() {
        this.apiUrl = 'https://newsapi.org/v2/top-headlines?category=sports'+ '&country=' + this.country +
                        '&pageSize=' + this.maxPerPage +
                        '&apiKey=' + this.apiKey;
        this.isBusy = true;
        this.searchword = '';
