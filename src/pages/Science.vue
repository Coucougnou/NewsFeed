  ...
  <div class="q-pa-md q-gutter-sm">
    <q-parallax :height="150">
      <template v-slot:media>
        <video poster="https://player.vimeo.com/external/254487664.sd.mp4?s=2240469fb6ab475300cf8975cf491b3243e86a1b&profile_id=165" autoplay loop muted>
          <source type="video/webm" src="https://player.vimeo.com/external/254487664.sd.mp4?s=2240469fb6ab475300cf8975cf491b3243e86a1b&profile_id=165">
          <source type="video/mp4" src="https://player.vimeo.com/external/254487664.sd.mp4?s=2240469fb6ab475300cf8975cf491b3243e86a1b&profile_id=165">
        </video>
      </template>
...
<script>
  export default {
    ...
    methods: {
      ...
      fetchTopNews() {
        this.apiUrl = 'https://newsapi.org/v2/top-headlines?category=science'+ '&country=' + this.country +
                        '&pageSize=' + this.maxPerPage +
                        '&apiKey=' + this.apiKey;
        this.isBusy = true;
        this.searchword = '';
